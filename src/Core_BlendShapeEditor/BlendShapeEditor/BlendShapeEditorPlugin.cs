...
namespace BlendShapeEditor
{
    ...
    public class BlendShapeEditorPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            BrushColorSmooth =
                Config.Bind("Colors - Brush", "Smooth", Color.green, "Color for the brush in Smooth mode");
            BrushColorInflate = Config.Bind("Colors - Brush", "Inflate", Color.magenta,
                "Color for the brush in Inflate mode");

            VertexColorDefault =
                Config.Bind("Colors - Mesh", "Vertex Default", Color.grey, "Default color for vertices");
            VertexColorHover =
                Config.Bind("Colors - Mesh", "Vertex Hovered", Color.yellow, "Hovered color for vertices");
            VertexColorSelected = Config.Bind("Colors - Mesh", "Vertex Selected", Color.green,
                "Selected color for vertices");

            WireColorDefault = Config.Bind("Colors - Mesh", "Wire Default", new Color(0, 0, 0, 0.3f),
                "Default color for edges");
            WireColorSelected = Config.Bind("Colors - Mesh", "Wire Selected", new Color(0, 200, 80, 200f),
                "Selected color for edges");
            WireColorMirror = Config.Bind("Colors - Mesh", "Wire Mirrored", new Color(0f, 0.6f, 0.8f, 0.78f),
                "Color for edges of mirrored vertices when symmetry is enabled");

            WeightGradientStop0 = Config.Bind("Colors - Weight Gradient", "Primary Stop 0 (weight 0.00)",
                new Color(0f, 0f, 1f),
                "Weight falloff gradient stop at weight 0.0 (low). Used for brush dots/edges and gizmo soft selection dots/edges.");
            WeightGradientStop1 = Config.Bind("Colors - Weight Gradient", "Primary Stop 1 (weight 0.33)",
                new Color(0f, 1f, 0f), "Weight falloff gradient stop at weight 0.33.");
            WeightGradientStop2 = Config.Bind("Colors - Weight Gradient", "Primary Stop 2 (weight 0.66)",
                new Color(1f, 1f, 0f), "Weight falloff gradient stop at weight 0.66.");
            WeightGradientStop3 = Config.Bind("Colors - Weight Gradient", "Primary Stop 3 (weight 1.00)",
                new Color(1f, 0f, 0f), "Weight falloff gradient stop at weight 1.0 (high).");
            WeightMirrorGradientStop0 = Config.Bind("Colors - Weight Gradient", "Mirror Stop 0 (weight 0.00)",
                new Color(0.1f, 0.1f, 0.5f), "Mirror-side weight falloff gradient stop at weight 0.0 (low).");
            WeightMirrorGradientStop1 = Config.Bind("Colors - Weight Gradient", "Mirror Stop 1 (weight 0.33)",
                new Color(0.1f, 0.6f, 0.7f), "Mirror-side weight falloff gradient stop at weight 0.33.");
            WeightMirrorGradientStop2 = Config.Bind("Colors - Weight Gradient", "Mirror Stop 2 (weight 0.66)",
                new Color(0.4f, 0.8f, 1f), "Mirror-side weight falloff gradient stop at weight 0.66.");
            WeightMirrorGradientStop3 = Config.Bind("Colors - Weight Gradient", "Mirror Stop 3 (weight 1.00)",
                new Color(1f, 1f, 1f), "Mirror-side weight falloff gradient stop at weight 1.0 (high).");
