...
namespace BlendShapeEditor
{
	public static class StudioUI
	{
		public static void Init()
		{
			...
			MaterialEditorBridge.UserInterfacePopulate += (s, e) => RefreshRenderers();
		}
		...
		public static void RefreshRenderers()
		{
			...
			if (Window.MatEditFilter)
			{
				MaterialEditorBridge.CurrentlyVisibleRenderers.ForEach(rend =>  Window.Renderers.Add(rend));
			}
			else
			{
